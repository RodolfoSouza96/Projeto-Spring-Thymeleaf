...
import br.com.rodolfo.projeto.controller.form.AtualizacaoAlunoForm;
...
public class AlunoController {
	...
	@GetMapping("/atualiza")
	public String atualiza(AtualizacaoAlunoForm form) {
			return "aluno/atualiza";
	}
	
	@PostMapping("/atualizanovo")
	@Transactional
    public String atualizanovo(@Valid AtualizacaoAlunoForm form, BindingResult result, Integer id) {
